...
| 503 | 🔄 | P1 | Умный конвейер РП | молчание починено (05.08); осталось токен + АрхГейт ledger-sync |
...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | Ф56 задеплоен + живой баг из другой сессии найден и исправлен 05.08 (--slug= форма); has_diff-баг блокирует сквозной прогон, 3-й повтор задокументирован |
