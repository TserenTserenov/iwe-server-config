...
| 7 | 🔄 | — | Платформа: техдолг (зонтичный) | 27.07: оба пункта Ф-Backup-Resilience-Audit закрыты (Mac-патч не нужен — уже чист; BetterStack heartbeat создан и записан на сервере); осталось — репетиция восстановления, B2-ключ |
