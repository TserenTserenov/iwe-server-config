...
| 520 | 🔄 | P2 | Новая версия конвейера закрытия сессии | 13.08 ноч: Ф11 batch7 — 27/34 находок параллельного разбора перенесены (PR#65); осталось ~19 (прод-инцидент identity-колонки отложен) |
