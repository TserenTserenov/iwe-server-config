...
| 520 | 🔄 | P2 | Новая версия конвейера закрытия сессии | 14.08: Ф11 закрыта финальной верификацией (разность 0, PR#69) + WP-524/WP-7 противоречие разрешено; судьба ветки peer/2026-08-12-06-wp484-watchdog-lang-check не решена (пилот: не трогать сейчас) |
