...
| 493 | 🔄 | P2 | Лаборатория характеристик | Ф4 ждёт данных (календарь 31.08); анонс Лаборатории — Ф-А1 РП167 |
| 494 | 🔄 | P2 | Панель рабочих продуктов в VS Code | ручная F5-приёмка пилотом |
| 495 | 🔄 | **P1** | Концепция персонального развития | 20.07: Ф9 первые 2 пункта done — метод DP.M.241 сверен с кодом (S4/S6 расходились) и переписан под факт; next: где живёт детальная карта (решение пилота) + состав малой группы Ф7 (решение пилота) |
...
| 497 | 🔄 | P5 | Материалы исследования AGI | Ф1 готова (#179); Ф2 открытые вопросы vs Ф3 попроще — решение пилота |
