...
| 5 | 🔄 | — | Платформа: развитие (зонтичный) | 22.07: weekly-release.yml — 2 CI-бага пофикшены+релиз v0.36.1 выпущен; tools/list-задержка — гипотеза плана устарела (fan-out уже параллельный), находка в карточке; Ubuntu-фаза П1+П2 done (heartbeat-гард day-open/day-close, 4 попутных бага); next: П3-П7 backlog, update.sh доставка локального SKILL.md |
...
| 476 | 🔄 | **P1** | Модель жизненного цикла данных | Ф2 нужен пилот; R15 №5 отложен |
