...
| 149 | 🔄 | **P1** | Персональные руководства | АрхГейт F6 не проходит; consent реализован fail-closed, 4/5 §Б открыты |
...
| 481 | 🔄 | **P1** | Каталог применений FPF-семинара к IWE | Ф25-план согласован (пир+Codex 10.08); ждёт пакет решений Ф25.1 |
