...
| 117 | 🔄 | — | Развитие nudge-системы | 19.07: AI-тексты + NudgeProducer done, Ф-decouple мержена (342/342 PASS, pilot+prod запушены); next: Ф-roles онбордер+маркер завершён-vs-заброшен |
...
| 7 | 🔄 | — | Платформа: техдолг (зонтичный) | 19.07 веч.: PRODSYNC3 — жёсткий гейт вместо предупреждения на backport-drift бота, 23 коммита разобраны (1 реальный перенос); next: iwe-llm-proxy/overnight-auditor ждут ручного действия пилота на tsekh-1 |
