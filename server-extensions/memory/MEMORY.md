...
- [project_strategy_session_nep_hypothesis_tracing_gap.md](project_strategy_session_nep_hypothesis_tracing_gap.md) — 10.08: рефлексия пилота на закрытии - процесс стратегирования не до конца учитывает неудовлетворённости и журнал гипотез при сборке плана недели; шаги 06a/06c кандидаты на доработку
- [project_ledger_day_file_recurring_stash_corruption.md](project_ledger_day_file_recurring_stash_corruption.md) — 10.08: `machine/ledger/day/.../day-2026-08-10.yaml` закоммичен с литеральными git-конфликт-маркерами 3 раза за день — активный источник, не найден, кандидат в РП-7
...
- [lessons_quick_close_ai_contract_output_must_be_bare_enum.md](lessons_quick_close_ai_contract_output_must_be_bare_enum.md) — 10.08: `verify-r23` и подобные шаги проверяют output-поле точным литералом (`verdict: pass`) через скрытый `close_check` в quick-close.yaml — обоснование/находки класть в отдельное сообщение, не в это поле
