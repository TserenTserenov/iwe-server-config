...
| 485 | 🔄 | P2 | Сверка дублирующихся скриптов root↔шаблон | 17.07 вечер: архитектурная дыра «root вне авто-pull сервера» закрыта — sync-extensions-auto.sh + launchd (2 раунда ревью, деплой на 114-файловом хвосте успешен); next: 8 файлов кластера Kimi Standalone + WP-295 (решения пилота) |
