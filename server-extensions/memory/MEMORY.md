...
| 510 | 🔄 | P3→P1 | ИИ-личности | 03.08 веч.: Ф10 Гари-онбордер заведена (пир-сессия -16 с Codex), черновики патчей 1-4 + инструкция цеху готовы; за пилотом: «дом» (Патч 1), Kit .2, состав personality_id; DR-03 ждёт приёмки; испытания 1-4 блокированы WP-484/WP-458 |
...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | подчинён РП-510; +Ф47 (шаг-протокол сессии); статус `inbox/WP-484/WP-484.md` |
