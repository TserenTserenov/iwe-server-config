...
| 510 | 🔄 | P3→P1 | ИИ-личности | 03.08 ночь: пир-сессия S2R-матрица закрыта; пилот утвердил Гари/F3, Рита/F1, метод Кира; next: внести в реестр личностей + цех-1 рассинхрон 157 коммитов (аккуратный cherry-pick, не push) |
| 5 | 🔄 | — | Платформа: развитие (зонтичный) | детали `inbox/WP-5/WP-5.md` |
| 117 | 🔄 | — | Развитие nudge-системы | Ф-adapt ждёт 4 недели рантайма |
| 149 | 🔄 | **P1** | Персональные руководства | целевой comparator задеплоен; ждёт ночного подтверждения (не probe) |
...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | 03.08: Ф47 gate_reviews done+АрхГейт пройден; open: `--live` re-run gap, 4 шаблон-разрыва ждут S-33 разрешения |
