...
| 503 | 🔄 | P1 | Умный конвейер РП | 28.07: Ф16.0 закрыта, Ф6 реализована (ночная актуализация + очередь решений, 2 новых скрипта, symmetric extract_blocker_wps); smoke нашёл и закрыл 3 дефекта; next Ф7 предодобренный пул |
