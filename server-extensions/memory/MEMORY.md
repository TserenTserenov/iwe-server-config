...
| 149 | 🔄 | **P1** | Персональные руководства | 21.07: fail-closed публикация подтверждена живьём (checklist_verdict: red-unresolved сработал, retry Pareto-сравнение отвергло проигравшую попытку); таймеры на 02:00 EEST задеплоены; next — дождаться streak=2 по недобору объёма для проверки алерта |
