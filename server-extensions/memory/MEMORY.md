...
| 251 | 🔄 | — | Системы службы продвижения | 30.07: агенда Ф4 обогащена (оргкартина команды, 5 РП семинара, финансирование одобрено); блокер тот же — живая сессия с Алёной |
...
| 406 | 🔄 | **P1** | Онбордер | 30.07 веч.: пилот выбрал 2 сценария Ф27 (рабочая задача + прямое сравнение), проработаны с опорой на реальный код-крючок (hermes.py:_maybe_offer_onboarder_after_conductor); Ф28 открыта — Телеграм-личность, сверка мандатов РП406/РП510/РП392 на одном коде; next пилоту — правка формулировок Ф27 + подтвердить разделение Ф28; Ф20/Ф22 без изменений |
...
| 484 | 🔄 | — | Автогенератор открытия/закрытия дня (зонтичный) | 30.07: Ф26 закрыта (пир-сессия с Kimi, 6 ходов) — duration_min всегда 0/неверный при повторном Close был связкой из 3 причин (slug вместо wp, orphan-переименование семафора, live-дубли по wp), не только slug-промаха; фикс залит и живьём подтверждён (этот же Close дал duration_min:121); Ф29 (30.07): ночной авторазбор заметок отключён на Mac+цехе, Day Open переведён на «только предложения, решение+дата пилота»; параллельно (30.07, пир-сессия с Codex): чек-лист устранения аудита закрытия/открытия (П1/П3/П4/Ф27-2/П6/П7) реализован — 6 фиксов задеплоены 4 репо + 8 systemd-юнитов на цехе (эскалация масштаба П6, подтверждена пилотом); next ретро-разбор 16 заметок с пилотом (таблица в Ф29) + живая ночная проверка П1/П3/П4 + 7 решений Ф18-Ф25/Ф27-Ф28 |
