...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | 10.08 Ф79+Ф80: idempotency+--only и Ф77 (cd-баг) починены и подтверждены живьём; боевой прогон всё равно упёрся в 2 новых блокера коммита (DayPlan-контент, scope-gate) поверх известного разрыва шаблона — WeekPlan W33 не доставлен, next решение пилота (правка хуков S-33 / ручная доставка) |
