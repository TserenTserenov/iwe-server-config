...
| 499 | 🔄 | P3 | Механизм подключения и переключения агентов IWE | 30.07: Ф16 полностью закрыта — 21 замечание ревью Fable 5 (2 прохода) устранены, все 3 архитектурных хвоста нашли дом и уже сдвинулись (двойник iwesys переименован и решён в WP-401 Ф6.5, серверный render-инструмент дизайн укреплён в WP-149, pid-баг оформлен issue в коде); next Ф4/Ф13/Ф14 |
...
| 510 | 🔄 | P3 | ИИ-личности | 30.07: Ф1 готова, прагматика дописана, фазы/обещания/сценарии подтверждены пилотом; пост «ИИ-личности: новое исследование» ready и запушен (183); next Ф2 онтология |
...
| 406 | 🔄 | **P1** | Онбордер | 30.07: Ф27 открыта — направление августа (массовый пользователь, Strategy.md) поднимает Д6 концепции Ф24 до мандата месяца: спроектировать «ага-момент» первой сессии против риска «ещё один ChatGPT» (3 критерия: рамка/контекст/путь к руководству + 3 черновика-сценария); браузерная технология = Андрей+Павел, ждём; Ф20/Ф22 без изменений, ждут пилота |
