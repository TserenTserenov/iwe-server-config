...
|-----|----|----|----------|----------------|
| 520 | 🔄 | P2 | Новая версия конвейера закрытия сессии | 12.08 ночь: кейс 9 закрыт (пир Кими), worktree-close узаконен; 10-й найден; Ф2-SLA 17.08 |
...
| 406 | 🔄 | **P1** | Онбордер | 11.08: Ф33 §4 закрыт с двух сторон (бот -25 + шлюз -30, выключен без секрета); за пилотом: секрет, вокабула, Ф20/Ф24; Ф22 разблокирован (код ~6-8ч) |
