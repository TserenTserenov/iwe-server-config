...
| 484 | 🔄 | — | Автогенератор открытия/закрытия дня (зонтичный) | 29.07 позд.веч.: Ф27 заведена — три находки дневного закрытия (разрыв механика/разговор повторился 2-й раз подряд, day-close.sh падает на reindex личных источников без --user-id, ветка бота new-architecture разошлась с pilot на 38 файлов); next 8 решений пилота по Ф18-Ф26 (минимум №1 и №7) + приоритет разбора Ф27 |
