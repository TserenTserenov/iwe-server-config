...
| 499 | 🔄 | P3 | Механизм подключения и переключения агентов IWE | 29.07 веч.: Ф16 закрыта (шлюз доставлен в шаблон: тег v0.1.0, setup-скрипт, манифест; 2 раунда ревью Fable 5 — 14 находок исправлены, скилл personal-guide-render переведён в честное состояние); хвосты Ф16: серверный render-инструмент (→WP-149), двойник iwesys (→WP-401), pid-баг демона к v0.2.0; next Ф13/Ф14 |
...
| 510 | 🔄 | P3 | ИИ-личности | 30.07: создан по поручению пилота, Ф1 карта мирового опыта готова, пост-анонс draft; next пилот согласует фазы Ф2-Ф7 и заголовок поста |
...
| 406 | 🔄 | **P1** | Онбордер | 29.07 веч.: Ф25/Ф26 закрыты — «Стажёр» убран из Pack (DP.SC.170/ROLE.067), цель = живая шкала Интересант→Определяющийся→Первокурсник (qualification_level); стенд МИМ = mim-iwe; 7 решений Д1-Д7 остались (мин. Д1+Д3); Ф20/Ф22 ждут пилота |
...
| 7 | 🔄 | — | Платформа: техдолг (зонтичный) | 29.07 веч.: баг «Освоиться» (кнопка не крепилась к автонуджу onboarder_gap) найден по жалобе участницы, фикс задеплоен на pilot@455bc6b2 и new-architecture@08bc6bab, дважды независимо проверен субагентом (до и после прода); по пути 2 гонки параллельных агентов на общем каталоге разрешены; #321/#323 (issue шаблона) по-прежнему за пилотом |
