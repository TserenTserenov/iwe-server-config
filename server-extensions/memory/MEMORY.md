...
| 485 | 🔄 | P2 | Сверка дублирующихся скриптов root↔шаблон | 03.08: ПЕРЕОТКРЫТ — обещание «расхождение обнаруживается систематически» не выполнено, сторож доставки нашёл 18 скриптов вне доставки; 17 ушли фазой в РП-7, здесь Ф7-Ф9 (сторож в ритм, обратный случай шаблон→канон, не-скриптовые классы) |
...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | 03.08: план Ф39-Ф45 (Fable, начать с Ф39, блокирует остальное) + Ф46 (гонка день/неделя, Claude) — оба ждут отдельной сессии реализации; полный статус → `inbox/WP-484/WP-484.md` |
