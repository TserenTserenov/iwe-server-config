...
| 503 | 🔄 | P1 | Умный конвейер РП | 28.07 ночь: Ф6.5 (стенд, 16/16) + Ф6.6 (фиксы) реализованы и запушены; Ф6.7 (systemd) код готов, install на tsekh-1 не произведён; бюджет 46h подтверждён пилотом; next install-systemd.sh на tsekh-1 → Ф7 |
