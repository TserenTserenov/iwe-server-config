...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | Ф55 05.08: реальный план дня доставлен (commit cda39f6bf) + PATH-баг systemd на tsekh закрыт, живой прогон 06.08 03:00 подтвердит глубину; IaC-разрыв unit-файлов — техдолг |
