...
|-----|----|----|----------|----------------|
| 498 | 🔄 | P2 | Наставник ИИ: оперативная помощь в чате | Ф1-Ф3 закрыты (4 итерации АрхГейта, связка из 4 ролей = MIM.R.001 Режим 2); next: Ф4 метод маршрутизации+grounding-гейт |
...
| 493 | 🔄 | P2 | Лаборатория характеристик | 20.07: Ф8 закрыт + автопубликация манифеста реализована (DP.SC.062, DP.ROLE.081 третий режим), 2 живых прогона success — снят downstream-блокер РП483 Ф6-Ф8 по линии РП493 полностью. Ф4 по-прежнему ждёт данных (календарь 31.08) |
