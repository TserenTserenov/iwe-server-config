...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | 04.08: Ф49 корень закрыт (возраст отзывает права, не существование; 30/30). Ждут пилота: копия сторожа в шаблоне старая (S-33), close/note-file выбирают первую сессию |
