...
| 149 | 🔄 | **P1** | Персональные руководства | 31.07: чек-лист догнал факт (Р7/1.13/1.3/1.15 закрыты, cold-review починил критичный краш ночного батча); `--probe` красный→жёлтый, пилот ждёт настоящий ночной рендер. Next: сверить `checks/2026-08-01.md` утром. Детали → `inbox/WP-149/чеклист-работ-до-зелёного-рендера.md` |
...
| 406 | 🔄 | **P1** | Онбордер | 30.07 веч.: Ф27 переписана после пир-сессии с Kimi (консенсус 2 хода) — сценарии показывают отличие от ChatGPT фактом, не словами; 31.07 (drift-фикс): Ф28 разблокирована — РП510 Ф2-Ф4 закрыты сегодня; next пилоту — сверить формулировки Ф27, живая приёмка Ф20, 3 решения Ф22, Ф28 стыковка |
