...
| 510 | 🔄 | P3→P1 | ИИ-личности | Ф21: доставка personality_id для Элара — главный приоритет пилота на 06.08 |
...
| 484 | 🔄 | **P1** | Автогенератор открытия/закрытия дня (зонтичный) | Ф62: Codex witness-паритет задеплоен (пир с Codex); next — по scope |
| 493 | 🔄 | P2 | Лаборатория характеристик | Ф4 ждёт данных (конец августа) |
| 494 | 🔄 | P2 | Панель рабочих продуктов в VS Code | F5-приёмка пройдена; доска сессий/раннеров активно продолжается |
