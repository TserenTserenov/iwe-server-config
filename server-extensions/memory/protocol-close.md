...
- [ ] **Гигиена карточки (РП-541 Ф5):** секция `## Осталось` единственная (тройная проверка R23 п.4); карточка на триггере архива (>14 дней И >400 строк) → архивация предложена пилоту (5c), не пропущена молча
