...
> **Саморазвитие = ссылка на активное РП персонального руководства** (например WP-149 «Система генерации персональных руководств», WP-245 «Программа личного развития»). Конкретная тема дня = next action из этого РП.
...
> Колонка **P** — проект (P1-P6) из [Projects.md](../docs/Projects.md). Если РП питает несколько — основной + через запятую (например `P3, P4`).
...
**Баланс по P:** P1 Xh · P2 Xh · P3 Xh · P4 Xh · P5 Xh · P6 Xh (сигнал перекоса на Week Close)
**Off-plan:** [список]
