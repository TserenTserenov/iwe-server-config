...
**Портфель в работе:** ~Yh РП всего / ~Xh физ / Плановый мультипликатор ~N.Nx
...
> Решает ТОЛЬКО пилот (30.07.2026, WP-484 Ф29). Агент заполняет Тип/Предложение — и всё; колонку «Решение пилота» не трогает.
> **«Все обработаны» писать можно ТОЛЬКО** если по каждой заметке в `archive/notes/Notes-Archive.md` есть запись «**Разбор:** дата — **Решение пилота:** …» (дать ссылку). git log сам по себе — не доказательство.
> **Неразобранное переносится в следующий DayPlan** — каждый день, без срока давности.

| Заметка | Тип | Предложение | Решение пилота |
|---------|-----|-------------|----------------|
| [«текст»](../inbox/fleeting-notes.md) (DD мес HH:MM) | НЭП / Задача / Черновик / Знание / Шум | → куда | ⏳ |
