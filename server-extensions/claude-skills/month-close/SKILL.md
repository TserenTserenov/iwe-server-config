...
**3c. Ретро месяца, свободный текст (WP-484, решение пилота 30.07 — рефлексия обязательна на всех тактах, CONCEPT-night-cycle.md §22).** [[gate]] Отдельно от фазы/калибра выше — спросить пилота:
