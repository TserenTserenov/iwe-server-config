...
Тонкий клиент — запускает сборку персонального руководства пилота: через локальный шлюз (`mcp__iwe-local-gateway__render_personal_guide`), если инструмент доступен, иначе серверным запуском на tsekh-1 (см. Шаг 2). Используй когда пилот просит «пересобери руководство», «обнови мой план», «собери руководство на сегодня».
