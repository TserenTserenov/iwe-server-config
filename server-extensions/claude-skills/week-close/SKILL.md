...
### 0. Сжатый свод недели [[narrative]]
...
Показать пилоту 3-5 строк: сколько коммитов за неделю по репозиториям + число закрытых/перенесённых РП (если уже известно на этот момент). Числа, не список дел — то же самое «не хватало цифр», что и в дне. Это и есть «сжатый свод накопленного», который стимулирует рефлексию (DP.D.288), не полный governance-разбор.
