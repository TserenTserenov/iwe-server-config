...
Source-of-truth: [B7.3.1-l2-data-classification-map.md](../../../DS-ecosystem-development/C.IT-Platform/C2.IT-Platform/C2.2.Architecture/Data-Governance/B7.3.1-l2-data-classification-map.md). Если затрагивается чувствительный класс — пройти 6 пунктов:
