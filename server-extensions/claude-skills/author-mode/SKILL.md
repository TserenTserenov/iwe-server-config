...
CLAUDE.md + ядро (protocol-*.md, .claude/rules/*.md): `bash $HOME/IWE/DS-ai-systems/setup/scripts/template-sync.sh` (sync / `--dry-run`; защищённый конвейер, отказывается перезаписывать файлы с чужими правками в FMT)
